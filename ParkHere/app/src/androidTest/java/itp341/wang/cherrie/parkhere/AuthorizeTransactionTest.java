...
public class AuthorizeTransactionTest {
    ...
    public void successfulLogoutTest() {
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.buttonAuthorize), withText("Authorize Pending Payments"), isDisplayed()));
        appCompatButton4.perform(click());

        onView(withText("Authorize Payment")).check(matches(isDisplayed()));
        // Click OK
        onView(withId(android.R.id.button1)).perform(click());
        onView(withText(R.string.dialog_authorize))
