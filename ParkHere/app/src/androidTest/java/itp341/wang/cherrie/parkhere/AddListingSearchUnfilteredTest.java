...
public class AddListingSearchUnfilteredTest {

    @Rule
    public ActivityTestRule<WelcomeActivity> mActivityTestRule = new ActivityTestRule<>(WelcomeActivity.class);

    @Test
    public void addListingSearchUnfilteredTest() {
        ...
        appCompatEditText4.perform(scrollTo(), replaceText("Corsica"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatCheckBox5 = onView(
                allOf(withId(R.id.wednesdayCheckBox), withText("Wednesday")));
        appCompatCheckBox5.perform(scrollTo(), click());

        ViewInteraction appCompatCheckBox6 = onView(
                allOf(withId(R.id.saturdayCheckBox), withText("Saturday")));
        ...
        appCompatEditText5.perform(scrollTo(), replaceText("this  is cool"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatTextView4 = onView(
                allOf(withId(android.R.id.text1), withText("Strict"), isDisplayed()));
        ...
        currencyEditText2.perform(scrollTo(), replaceText("$0.013"), closeSoftKeyboard());

        ViewInteraction currencyEditText3 = onView(
                allOf(withId(R.id.priceEditText), withText("$0.13")));
        currencyEditText3.perform(scrollTo(), replaceText("$0.139"), closeSoftKeyboard());

        ViewInteraction currencyEditText4 = onView(
                allOf(withId(R.id.priceEditText), withText("$1.39")));
        currencyEditText4.perform(scrollTo(), replaceText("$1.396"), closeSoftKeyboard());
        ...
        ViewInteraction view = onView(
                allOf(withContentDescription("Corsica. "),
                        childAtPosition(
